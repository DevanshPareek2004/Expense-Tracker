...
def send_email(to_email, subject, body, attachment_path=None):
    sender_email = "expenseflow.app@gmail.com"  # Replace with your email
    sender_password = "bcwgbkguaoiijavw"  # Replace with your app password
...
def send_otp_email(to_email):
    otp = generate_otp()  # Generate a 4-digit OTP
...
def generate_transactions_pdf(transactions, user_email):
    ...
    # Use a standard font (Helvetica is built into FPDF)
    ...
    # Add a subtitle with the user's email
    ...
    for transaction in transactions:
        # Display only the numeric amount (without currency symbol)
        amount = f"{transaction['amount']:.2f}"  # Format the amount to 2 decimal places
        ...
        pdf.cell(30, 10, amount, border=1)  # Display the amount without currency symbol
        pdf.ln()
